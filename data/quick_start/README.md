...
[Quick start (end to end)](https://joseah.github.io/Dynema.jl) tutorial:
300 donors, 4,050 cells, 3 genes with 500 cis-variants each. Generated by
`simulate_quick_start_data.py` (repo root, seeded -- reproducible).
